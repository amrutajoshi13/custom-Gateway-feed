...
/////////////////////////////////////////////////////////////////////		
	...
	s.option(L.cbi.ListValue,'protocol_lan',{          
      ...
      s.option(L.cbi.CheckboxValue, 'ipmodelandelegateprefix', {
         ...
         optional: true
      }).depends({ 'ipmodewan': '1', 'protocol': 'static' })
         .depends({ 'ipmodelan': '1', 'protocol_lan': 'static_lan' });
      ...
      s.option(L.cbi.ComboBox, 'ipv6delegateprefix', {
         ...
         .depends({ 'ipmodelan': '1', 'ipmodelandelegateprefix': '1' });
      ...
      s.option(L.cbi.InputValue, 'ra_mininterval', {
         ...
         optional: 'true',
         placeholder: '30',
      }).depends({ 'ipmodelan': '1', 'ipv6interval': '1' });
      ...
      s.option(L.cbi.ListValue, 'dhcpserver', {
         caption: L.tr('DHCP Server Configuration'),
      }).depends({ 'type': 'LAN' })
         .value("disable_dhcpv4v6", L.tr("Disable DHCPv4 and DHCPv6 Server"))
         .value("enable_dhcpv4", L.tr("Enable DHCPv4 Server"))
         .value("enable_dhcpv6", L.tr("Enable DHCPv6 Server"))
         .value("enable_dhcpv4v6", L.tr("Enable DHCPv4 and DHCPv6 Server"));

      //IPV6 Addresssing Mode_LAN
      s.option(L.cbi.ListValue, 'ipv6addressingmode', {
         ...
         .depends({ 'protocol_lan': 'static_lan', 'dhcpserver': 'enable_dhcpv6', 'ipmodelan': '1' })
         .depends({'protocol_lan': 'static_lan','dhcpserver':'enable_dhcpv4v6','ipmodelan': '1'});
      ...
      s.option(L.cbi.ListValue, 'ipv6relayingmode', {
         ...
         .value("wan6", L.tr("WAN6"))
         //.depends({ })
         .depends({ 'protocol_lan': 'static_lan', 'dhcpserver': 'enable_dhcpv6', 'ipmodelan': '1', 'ipv6addressingmode': 'ipv6_relay' })
         .depends({ 'protocol_lan': 'static_lan', 'dhcpserver': 'enable_dhcpv6', 'ipmodelan': '1', 'ipv6addressingmode': 'ipv6_relay_hybrid' })
         .depends({'protocol_lan': 'static_lan','dhcpserver':'enable_dhcpv4v6','ipmodelan': '1','ipv6addressingmode': 'ipv6_relay' })
         .depends({'protocol_lan': 'static_lan','dhcpserver':'enable_dhcpv4v6','ipmodelan': '1','ipv6addressingmode': 'ipv6_relay_hybrid'});
         
      s.option(L.cbi.InputValue, 'ServerDHCPrange', {
         caption: L.tr('DHCP Start Address'),
         datatype: 'uinteger',
         optional: true
      }).depends({ 'protocol_lan': 'static_lan', 'type': 'LAN', 'dhcpserver': 'enable_dhcpv6' })
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver': 'enable_dhcpv4'})
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver':'enable_dhcpv4v6'});
         ...
         s.option(L.cbi.InputValue, 'leasetimehr', {
           caption: L.tr('Lease time'), 
             placeholder:'12',
              datatype: 'uinteger',
           optional: true
        }).depends({ 'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver': 'enable_dhcpv6','leasetime_duration':'h'})
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver': 'enable_dhcpv4','leasetime_duration':'h'})
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver':'enable_dhcpv4v6','leasetime_duration':'h'});
        ...
        s.option(L.cbi.InputValue, 'leasetimemin', {
           ...
           optional: true
        }).depends({ 'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver': 'enable_dhcpv6','leasetime_duration':'m'})
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver': 'enable_dhcpv4','leasetime_duration':'m'})
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver':'enable_dhcpv4v6','leasetime_duration':'m'});
         ...
         s.option(L.cbi.InputValue, 'leasetimesec', {
           ...
           optional: true
        }).depends({ 'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver': 'enable_dhcpv6','leasetime_duration':'s'})
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver': 'enable_dhcpv4','leasetime_duration':'s'})
      .depends({'protocol_lan': 'static_lan', 'type': 'LAN','dhcpserver':'enable_dhcpv4v6','leasetime_duration':'s'});
   ...
   s.option(L.cbi.CheckboxValue, 'custom_DHCP_options', {
           ...
           caption: L.tr('Eanble Custom Subnet Mask (Option 1)'),
		...
		s.option(L.cbi.CheckboxValue, 'enable_gateway', {
           caption: L.tr('Eanble Custom Gateway (Option 3)'),
         }).depends({'protocol_lan':'static_lan','type':'LAN','enable_dhcpserver':'1','custom_DHCP_options':'1'});
		...
		s.option(L.cbi.CheckboxValue, 'enable_dns', {
           caption: L.tr('Eanble Custom DNS (Option 6)'),
         }).depends({'protocol_lan':'static_lan','type':'LAN','enable_dhcpserver':'1','custom_DHCP_options':'1'});
		...
		s.option(L.cbi.CheckboxValue, 'enable_ntp_sever', {
           caption: L.tr('Eanble Custom NTP Server (Option 42)'),
         }).depends({'protocol_lan':'static_lan','type':'LAN','enable_dhcpserver':'1','custom_DHCP_options':'1'});
		...
		s.option(L.cbi.CheckboxValue, 'enable_tftp_server', {
           caption: L.tr('Eanble Custom TFTP Server (Option 66)'),
         }).depends({'protocol_lan':'static_lan','type':'LAN','enable_dhcpserver':'1','custom_DHCP_options':'1'});
		...
		s.option(L.cbi.CheckboxValue, 'enable_bootfile', {
           caption: L.tr('Eanble Custom Bootfile Name (Option 67)'),
         }).depends({'protocol_lan':'static_lan','type':'LAN','enable_dhcpserver':'1','custom_DHCP_options':'1'});
		...
		s.option(L.cbi.CheckboxValue, 'enable_custom_option', {
           caption: L.tr('Eanble Custom option'),
         }).depends({'protocol_lan':'static_lan','type':'LAN','enable_dhcpserver':'1','custom_DHCP_options':'1'});
