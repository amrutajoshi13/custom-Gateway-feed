(function() {
	var ui_class = {
		...
		updateinterfaceconfig: L.rpc.declare({
			object: 'rpc-UpdateSessionTime',
			method: 'configure'
		}),

		WebpageFileCall: function () {
			console.log("excuted")
			this.updateinterfaceconfig("configure").then(function (rv) {
				console.log("Response:", rv);
				var SessionTime = rv.output;
...
if(_tag =="TCP Slave configration"){
      _tag ="<p><img src='/luci2/icons/TCP.svg' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
...
if(_tag == "Health Monitoring"){
	_tag ="<p><img src='/luci2/icons/routerhealthstatus.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
}
...
if(_tag == "Data Source Configuration"){
      _tag ="<p><img src='/luci2/icons/iosource.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }  
...
if(_tag == "App Health Status"){
      _tag ="<p><img src='/luci2/icons/healthstatus.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";  
  }
...
if(_tag =="VRRP"){                                                                                                                            
      _tag ="<p><img src='/luci2/icons/vrrp.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";                                                   
  }  
if(_tag == "VLAN"){                                                                                                                           
       _tag ="<p><img src='/luci2/icons/vlan.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";                                                  
  }      
 if(_tag == "DMZ"){                                                                                                                           
       _tag ="<p><img src='/luci2/icons/dmz.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";                                                  
  }   
if(_tag == "Set Primary Sim"){                                                                                                                           
       _tag ="<p><img src='/luci2/icons/DefaultPrimarysim.png' class='Subimag'>&nbsp&nbsp"+_tag+"</p>";                                                  
  } 
}
