...
echo "=====================================================================================                                                   
                                 BOARD TEST                                                                                                   
====================================================================================="  
if [ "$res1" = "y" ] && [ "$res2" = "y" ] && [ "$res3" = "y" ] && [ "$res4" = "y" ] && [ "$res5" = "y" ] && [ "$res8" = "y" ] && [ "$res9" = "y" ] && [ "$res10" = "y" ] && [ "$res12" = "y" ] && [ "$res13" = "y" ] && [ "$res14" = "y" ] && [ "$res15" = "y" ] && [ "$res16" = "y" ] && [ "$res17" = "y" ]; then
...
#echo "Ethernet 3 Ping Test:$ping_test3"

#ping_test4=$(cat "$file" | grep "Ethernet 4 Ping Test" | cut -d "=" -f 2 | tr -d ' ')
#echo "Ethernet 4 Ping Test:$ping_test4"
...
while [ $attempts -lt $max_attempts ]; do
    if ping -c 1 -W 2 "productionapp.silbo.co.in" &> /dev/null; then
        ...
        curl --data "$data" -v https://productionapp.silbo.co.in/api/save_data/
