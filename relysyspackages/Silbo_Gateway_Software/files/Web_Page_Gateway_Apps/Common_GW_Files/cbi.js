(function () {
	...
	validation.types = {
		...
		'uintegerMultipleOf60': function () {
			
			if (validation.types['integer'].apply(this) && (this >= 1) && (this % 60 === 0))
				return true;

			validation.i18n('Must be a positive integer which is divisble by 60');
			return false;
		},
	...
	cbi_class.AbstractValue = L.ui.AbstractWidget.extend({
		...
		render: function (sid, condensed) {
			...
			if (!condensed) {
				...
				console.log(this.options.caption);
					$('<label />')
