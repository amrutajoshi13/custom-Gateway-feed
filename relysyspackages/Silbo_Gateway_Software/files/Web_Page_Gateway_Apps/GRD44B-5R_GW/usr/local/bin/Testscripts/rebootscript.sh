#!/bin/sh
# Define Text color
#source /usr/local/bin/Testscripts/Testresult/output1file.txt
...
echo "=====================================================================================                                                   
                                 BOARD TEST                                                                                                   
====================================================================================="  
if [ "$res1" = "y" ] && [ "$res2" = "y" ] && [ "$res3" = "y" ] && [ "$res4" = "y" ] && [ "$res5" = "y" ] && [ "$res6" = "y" ] && [ "$res7" = "y" ] && [ "$res8" = "y" ] && [ "$res9" = "y" ] && [ "$res10" = "y" ] && [ "$res11" = "y" ]  && [ "$res12" = "y" ] && [ "$res13" = "y" ] && [ "$res14" = "y" ] && [ "$res15" = "y" ] && [ "$res16" = "y" ] && [ "$res17" = "y" ] && [ "$res18" = "y" ]; then
...
if [ "$wifi_enable_disable" = "0" ];then
	if echo "$board_name" | grep -qE "(Silbo_IAB|IAC|GRD)";then
...
if [ "$wifi_enable_disable" = "0" ];then
	if echo "$device_model" | grep -qE "(Silbo_IAB|IAC|GRD)";then
		device_model=$(echo "$device_model" | sed 's/./0/10')
	fi
	if echo "$device_model" | grep -qE "(Silbo_IA44|IE44)";then
...
status=0
if [ "$res1" = "y" ] && [ "$res2" = "y" ] && [ "$res3" = "y" ] && [ "$res4" = "y" ] && [ "$res4" = "y" ] && [ "$res5" = "y" ] && [ "$res6" = "y" ] && [ "$res7" = "y" ] && [ "$res8" = "y" ] && [ "$res9" = "y" ] && [ "$res10" = "y" ] && [ "$res11" = "y" ] && [ "$res12" = "y" ] && [ "$res13" = "y" ] && [ "$res14" = "y" ] && [ "$res15" = "y" ] && [ "$res16" = "y" ]  && [ "$res17" = "y" ] && [ "$res18" = "y" ]; then
